...
class LevelScene: MenuScene {
    ...
    */
    func setupInstructionBlocks() -> SKSpriteNode {
        ...
        let height = _height * 0.5
        let width = (_width * (1/3.5)) + 4
        ...
        let y = _height - (body.size.height * 0.5)
    ...
    */
    func setupProgram() -> SKSpriteNode {
        ...
        body.size = CGSize(width: _width * (1 - 1/3.5), height: _height * 0.5)
        body.position = CGPoint(x: (_width * (1/3.5)) + (body.size.width * 0.5), y: _height - (body.size.height * 0.5))
        body.zPosition = -1
    ...
    */
    func setupOutput() -> SKSpriteNode {
        ...
        body.size = CGSize(width: _width, height: _height * 0.5)
